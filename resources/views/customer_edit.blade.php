                                ...
                                <div class="col-4">
                                    ...
                                    <div class="col">
                                        <input id="middle_name" type="text"
                                            ...
                                            name="middle_name" value="{{ old('middle_name', $customer->middle_name) }}"
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="col">
                                        <input id="nic" type="text"
                                            ...
                                            value="{{ old('nic', $customer->nic) }}" required autocomplete="nic" autofocus>
                                        @error('nic')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="col-8">
                                        <input id="dob" type="date"
                                            ...
                                            value="{{ old('dob', $customer->dob) }}" required autocomplete="dob"
                                            autofocus>
                                        @error('dob')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="col">
                                        <input id="email" type="email"
                                            ...
                                            value="{{ old('email', $customer->email) }}" required autocomplete="email"
                                            autofocus>
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="col">
                                        <input id="address_line_1" type="text"
                                            ...
                                            name="address_line_1"
                                            value="{{ old('address_line_1', $customer->address_line_1) }}" required
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="col">
                                        <input id="address_line_2" type="text"
                                            ...
                                            name="address_line_2"
                                            value="{{ old('address_line_2', $customer->address_line_2) }}" required
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="col">
                                        <input id="address_line_3" type="text"
                                            ...
                                            name="address_line_3"
                                            value="{{ old('address_line_3', $customer->address_line_3) }}" required
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="col">
                                        <input id="postal_code" type="number"
                                            ...
                                            name="postal_code" value="{{ old('postal_code', $customer->postal_code) }}"
